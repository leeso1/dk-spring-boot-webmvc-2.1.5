...
public class JsonWebToken {
    public static void main(String[] args) throws Exception {
        System.out.println("DEV :" + genenateToken(2101183L, 190526002003230493L, EnvironmentConfig.DEV));
        System.out.println("QA : " + genenateToken(7202141L, 7203621L, EnvironmentConfig.QA));
